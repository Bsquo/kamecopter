...
:: Compile CPP
echo "Compiling cpps..."
..\..\..\cw\mwcceppc -I- -i ../../../k_stdlib -Cpp_exceptions off -enum int -RTTI off -once -O4,s -use_lmw_stmw on -fp fmadd -rostr -sdata 0 -sdata2 0 -c -o one_life.o one_life.cpp

:: Link
:: Because our custom code in one_life.cpp will be loaded dynamically by the loader 
...
..\..\..\Kamek\bin\Debug\Kamek one_life.o -dynamic -externals=symbols_EUR.txt -output-kamek=test_P.bin
del *.o >NUL
ENDLOCAL